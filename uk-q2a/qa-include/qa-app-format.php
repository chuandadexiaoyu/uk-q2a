...
function qa_set_up_tag_field(&$qa_content, &$field, $fieldname, $tags, $exampletags, $completetags, $maxtags)
	{
		...
		$field['tags']='NAME="'.$fieldname.'" ID="tags" AUTOCOMPLETE="off"';
...
<SPAN>
<A  CLASS="qa-tag-link qa-version" ID="version01" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">Ubuntu kylin 13.04</SPAN></A>
<A  CLASS="qa-tag-link qa-version" ID="version02" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">Ubuntu kylin 13.10</SPAN></A>
<A  CLASS="qa-tag-link qa-version" ID="version03" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">Ubuntu kylin 14.04</SPAN></A>
<A  CLASS="qa-tag-link qa-version" ID="version04" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">其他版本...</SPAN></A>
...
<SPAN>厂商型号：</SPAN>
<SPAN>
<A  CLASS="qa-tag-link qa-shop" ID="shop01" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">联想(lenovo)</SPAN></A>
<A  CLASS="qa-tag-link qa-shop" ID="shop02" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">宏碁(acer)</SPAN></A>
<A  CLASS="qa-tag-link qa-shop" ID="shop03" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">惠普</SPAN></A>
<A  CLASS="qa-tag-link qa-shop" ID="shop04" onclick="return qa_tag_click(this);"><SPAN STYLE="font-weight:normal;">其他厂商...</SPAN></A>
其他厂商<INPUT TYPE="text"  CLASS="qa-tag-input qa-shop" ID="shop05" onchange="return qa_tag_click(this);"></INPUT>
</SPAN>
</SPAN>'.
'<br><br>'.
...
'<SPAN ID="tag_hints">
<SPAN>随意写哦，亲：</SPAN>
<INPUT TYPE="text" ID="any-input" onchange="return qa_any_click(this)"></INPUT>
</SPAN>'
