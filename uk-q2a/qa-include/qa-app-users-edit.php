...
//config.inc.php must appear first

require_once QA_BASE_DIR.'config.inc.php';
require_once QA_UCCLIENT_DIR.'client.php';
...
function qa_check_register_uc(&$handle, &$email, &$password)
{
$errors=array();

$uid=uc_user_register($handle, $password, $email);
...
/*COPY OF qa_handle_email_filter(&$handle, &$email, $olduser=null)
