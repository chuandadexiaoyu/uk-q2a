...
*/
	...
	*/
	...
	//	search() outputs <div class="qa-search">, q_list() outputs <div class="qa-q-list">, etc...
		...
		function head_links()
		{
			...
			$this->output('<link rel="stylesheet" type="text/css" href="./qa-theme/SnowT/jquery.tagsinput.css" />');
		...
		function head_script()
		{
			...
			if (isset($this->content['script']))
				foreach ($this->content['script'] as $scriptline)
					...
					$this->output('<script src="./qa-content/tagsinput.js"></script>');
					$this->output('<script src="./qa-content/qa-ask.js"></script>');
		}
		...
		function head_css()
		{
			...
			$this->output('<link rel="stylesheet" type="text/css" href="http://xoxco.com/x/tagsinput/jquery-autocomplete/jquery.autocomplete.css" />');
	...
	*/
		...
		function q_item_main($q_item)//输出问题那页瘿
		{
			$this->output('<div class="qa-q-item-main">');
			
			$this->view_count($q_item);
			$this->q_item_title($q_item);//显示问题标题
			$this->q_item_content($q_item);
			
			$this->post_tags($q_item, 'qa-q-item');//显示问题标签
			$this->post_avatar_meta($q_item, 'qa-q-item');//显示问题的一些参擿
		...
		function post_tags($post, $class)//显示标签函数
		{
		...
		function post_tag_list($post, $class)//标签列表函数
		{
