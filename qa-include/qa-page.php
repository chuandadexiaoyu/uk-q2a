...
global $todiscuz;
$todiscuz = "http://192.166.1.107/discuz/member.php?mod=register&fromq2a=q2a";
	...
	if (QA_DEBUG_PERFORMANCE)
{
	...
	$qa_content=qa_get_request_content(); // get content
	...
	if (is_array($qa_content)) {
		...
		qa_output_content($qa_content);  // output content
//echo "<DIV></DIV>"
